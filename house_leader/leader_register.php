...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($error_message)) {
        ...
        if ($stmt_tenant->execute()) {
            ...
            // Insert into `housemate_role` table with 'leader' role
            $query_role = "INSERT INTO housemate_role (tenant_id, house_role) VALUES (?, 'leader')";
            ...
            if ($stmt_role->execute()) {
                ...
                $error_message = "An error occurred while assigning the leader role.";
            }
        } else {
...
<head>
  ...
  <title>Leader Registration - Stay1B</title>
  <link rel="stylesheet" href="../css/leader.css">
</head>
<body>

  <main>
  <h1 style="text-align: center; color: #554940;">House Leader Register</h1>
    <form class="leader-registration-form" action="leader_register.php" method="POST" enctype="multipart/form-data">
      <label for="tenant_full_name" class="leader-registration-label">Full Name:</label>
      ...
      <label for="tenant_username" class="leader-registration-label">Username:</label>
      ...
      <label for="tenant_password" class="leader-registration-label">Password:</label>
      ...
      <label for="tenant_email" class="leader-registration-label">Email:</label>
      ...
      <label for="tenant_whatsapp" class="leader-registration-label">Contact:</label>
      ...
      <label for="tenant_picture" class="leader-registration-label">Upload Profile Picture:</label>
      <input type="file" id="tenant_picture" name="tenant_picture" accept="image/*">

      <button type="submit" class="leader-registration-button">Register</button>

      <p class="form-link" style="text-align: center;">
        Already have an account? <a href="leader_login.php">Login here</a>
      </p>
    </form>
